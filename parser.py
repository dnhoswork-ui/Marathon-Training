...
class RunData(BaseModel):
    ...
    max_hr: Optional[int] = Field(None, description="Maximum heart rate in bpm, or null")
    cadence_spm: Optional[int] = Field(None, description="Average run cadence in steps per minute, or null")
    stride_length_m: Optional[float] = Field(None, description="Average stride length in metres, or null")
    ...
    avg_power_w: Optional[int] = Field(None, description="Average running power in watts, or null")
